...
type OptimizedAuthProtectedProps = {
  children: React.ReactNode;
  requireOnboarding?: boolean;
};

const OptimizedAuthProtected = ({ children, requireOnboarding = true }: OptimizedAuthProtectedProps) => {
...
export default OptimizedAuthProtected;
