...
const Signup = () => {
  ...
  const formValidation = useMemo(() => ({
    step1Valid: !!userType,
    step2Valid: formData.agreeToTerms && formData.email && formData.password && formData.confirmPassword,
    passwordsMatch: formData.password === formData.confirmPassword
  }), [userType, formData]);

  const handleNext = useCallback(() => {
    if (step === 1 && formValidation.step1Valid) {
      setStep(2);
    } else if (step === 2) {
      handleSignUp();
    }
  }, [step, formValidation.step1Valid]);
  ...
  // Enhanced sign up handler with preventDefault and navigation stability
  const handleSignUp = useCallback(async () => {
    ...
    try {
      ...
      // Stable navigation with message state
      navigate("/login", { 
  ...
  }, [formValidation.passwordsMatch, isSubmitting, signUp, formData.email, formData.password, navigate]);

  // Enhanced Google sign up with stability
  ...
  // Enhanced form submission handler with preventDefault
            ...
            <form onSubmit={handleFormSubmit}>
              ...
              <div className="flex justify-between pt-6">
                ...
                <div className="ml-auto">
                  <Button
                    type="submit"
                    disabled={step === 1 ? !formValidation.step1Valid : !formValidation.step2Valid || isSubmitting}
