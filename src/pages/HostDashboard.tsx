...
import { HostDashboardHeader } from "@/components/host/dashboard/HostDashboardHeader";
import { HostDashboardMetrics } from "@/components/host/dashboard/HostDashboardMetrics";
import { HostDashboardTabs } from "@/components/host/dashboard/HostDashboardTabs";
...
const HostDashboard = () => {
  ...
  return (
    <div className="container mx-auto py-8 space-y-8">
      <HostDashboardHeader firstName={authState.profile?.first_name} />
      <HostDashboardMetrics metrics={metrics} />
