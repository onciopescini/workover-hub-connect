...
serve(async (req) => {
  ...
  try {
    ...
    // -------------------------------------------------------------------------
    console.log("🚀 PAYMENT SESSION V4 - DECOUPLED LOADED 🚀");
    ...
    console.log('[CREATE-PAYMENT-SESSION] Payload:', JSON.stringify(body, null, 2))
    ...
    console.error('[CREATE-PAYMENT-SESSION] FATAL ERROR:', error)
    return new Response(
