-- 1) Restrict public access to booking_reviews by updating RLS policies
-- Remove public visibility and restrict to only participants and space hosts for visible reviews
...
-- 2) Drop and recreate space reviews function without author_id/target_id
